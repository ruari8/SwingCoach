...
- Uses the same `Capture practice swings` preference as Capture. Changing that preference stops and clears the active replay, as changing source timing does.
