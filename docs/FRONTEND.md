...
- The impact-centered detector now treats addressed-ball departure plus strike attribution as the primary proof of impact. Direct club/ball contact must also have strike-like local motion, which rejects address/clubhead-covering occlusions. If exact club contact is missed at a lower sample rate, a very clean ball departure can still pass when the returned impact window has strong swing-shaped club/motion evidence.
