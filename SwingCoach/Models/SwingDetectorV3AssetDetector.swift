//
//  SwingDetectorV3AssetDetector.swift
//  SwingCoach
//
//  Offline asset reader that drives the same SwingDetectorV3 loop used by live
...
actor SwingDetectorV3AssetDetector {
    ...
    func detectSwings(in asset: AVAsset) async throws -> [DetectedSwing] {
        ...
        let detector = SwingDetectorV3(configuration: configuration)
