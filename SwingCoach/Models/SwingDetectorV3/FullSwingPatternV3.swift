...
nonisolated enum FullSwingPatternV3 {
    ...
    static func confirmedDips(in samples: [SwingObservationV3]) -> [Double] {
    ...
    static func swungClubVisible(around t: Double, in samples: [SwingObservationV3]) -> Bool {
        ...
        for sample in window {
            ...
            anchoredClubDetections += clubs.filter {
                GeometryV3.distance($0.center, wrist) <= radius
            }.count
        }
